...
$mobil = read("SELECT * FROM data_album WHERE KODE = '$plt'")[0];
    ...
    <div class="container">
        <form action="" method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="KODE" name="KODE" value="<?= $album['KODE'] ?>" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="VERSI" name="VERSI" value="<?= $album['VERSI'] ?>" required>
            </div>
            <div class="mb-3">
                <label for="HARGA" class="form-label">HARGA :</label>
                <input type="text" class="form-control" id="HARGA" name="HARGA" value="<?= $album['HARGA'] ?>" required>
            </div>
            <div class="mb-3">
